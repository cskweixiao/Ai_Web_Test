...
本文档提供 Ai Web Test 的详细安装步骤和配置说明。
...
```bash
DATABASE_URL="mysql://username:password@localhost:3306/ai_web_test?timezone=Asia/Shanghai"
```
...
```bash
# ========== AI 模型配置 ==========
# Ai Web Test 支持 4 种 AI 模型,可在前端设置页面一键切换
...
```sql
CREATE DATABASE ai_web_test CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
```
