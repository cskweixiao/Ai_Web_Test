# Ai Web Test: AI驱动的自动化测试平台

一个开源的测试平台，核心功能包括**AI测试用例生成**和**UI自动化测试执行**。
...
- GitHub: https://github.com/Ai Web Test/Ai Web Test
- 问题反馈: https://github.com/Ai Web Test/Ai Web Test/issues

---

**如果Ai Web Test对你有帮助，欢迎给项目一个Star支持！**

Made with ❤️ by Ai Web Test Team
